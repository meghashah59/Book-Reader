...
/* Meta Information 
 * Adapted from Johannes 4 GNU/Linux: 
 * https://github.com/Johannes4Linux/Linux_Driver_Tutorial/blob/main/22_dt_i2c/dt_i2c.c
*/

/* TO DO
 * current state: very simple i2c skeleton
